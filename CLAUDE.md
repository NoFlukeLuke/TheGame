...
- **Build stamp:** bump the `BUILD` constant (near top of `<script>`, currently `'2026-06-13 · r48'`) on every commit. It shows in the menu footer + dev panel so the owner can confirm mobile cache is fresh. Increment the `rN` each commit.
