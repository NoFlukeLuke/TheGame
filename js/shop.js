...
// ── New shop state ──
const SHOP_TRICK_PRICES   = scalePriceTable({ common: 5, rare: 8, epic: 12, legendary: 18, mythic: 25 });
const SHOP_KNACK_PRICE    = priceOf(10);
const SHOP_SLEIGHT_PRICES = scalePriceTable({ common: 8, rare: 12, epic: 16, legendary: 22, mythic: 28 });
