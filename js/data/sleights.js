...
//  { id:'shortcut',      name:'Shortcut',       emoji:'⏩', rarity:'legendary', activation:'on_play',    durability:1,          defaultRank:null, defaultSuit:null, tags:['challenge'],                 desc:'Play it in any 4-card hand to instantly complete the active challenge. (Once)' },
  ...
  { id:'fight_power',   name:'Fight the Power',emoji:'⚔️', rarity:'legendary', activation:'passive',    durability:9, secsPerCharge:20, defaultRank:null, defaultSuit:null, tags:['boss'],                      desc:'While on the grid, all boss effects are ignored (3 minutes of use, each 20 seconds count as 1 charge).' },
  ...
  { id:'stopwatch',      name:'Stopwatch',      emoji:'⏱️', rarity:'epic',      activation:'double_tap', durability:10, secsPerCharge:6, defaultRank:null, defaultSuit:null, tags:['time'],                desc:'Double-tap: freeze the clock until your next played hand (60s of use, each 6 seconds count as 1 charge).' },
  ...
  { id:'magnet',         name:'Magnet',         emoji:'🧲', rarity:'common',    activation:'double_tap', durability:3,          defaultRank:null, defaultSuit:null, tags:['position','swap'],    desc:'Double-tap, then tap any card: pull every card of that rank in to replace the Magnet and the cards beside it (they are discarded). (3 charges)' },
  // ── Aim-based (fixtures: tap to rotate aim; cannot be swapped or discarded) ──
  { id:'reflect',     name:'Reflect',     emoji:'🪞', rarity:'epic',   activation:'aim', durability:'infinite', defaultRank:null, defaultSuit:null, tags:['retrigger','position'], desc:'Tap to rotate its aim. The rank it faces replays 2x when scored. Cannot be swapped, discarded or played. Discards itself after 60s.' },
  { id:'soul_mirror', name:'Soul Mirror', emoji:'👁️', rarity:'legendary', activation:'aim', durability:'infinite', defaultRank:null, defaultSuit:null, tags:['retrigger','rank'],     desc:'Tap to rotate its aim. When the rank it faces is scored, it replays once for each count of that rank in the deck. Cannot be swapped, discarded, or played.' },
  // ── Adjacency / position sleights (r120) ──
  { id:'whetstone',  name:'Whetstone',  emoji:'🔪', rarity:'epic', activation:'passive', durability:'infinite', defaultRank:null, defaultSuit:null, tags:['scoring','mult','position'], desc:'Whenever an adjacent card is swapped or discarded, Whetstone gains +2 mult permanently. Hands that score a card adjacent to Whetstone score that mult. Discards itself after 90s on the board.' },
  ...
  { id:'siphon',    name:'Siphon',    emoji:'🩸', rarity:'rare',   activation:'double_tap', durability:4, defaultRank:null, defaultSuit:null, tags:['focus','mult'],  desc:'Double-tap to spend 15 Focus: your next scored hand gets ×4 mult. Discards on use.' },
