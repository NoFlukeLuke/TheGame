...
const SLEIGHT_POOL = [
  ...
  { id:'warehouse',     name:'Warehouse',      emoji:'🏭', rarity:'common',      activation:'wildcard',   wild:'suit', durability:'infinite', defaultRank:null, defaultSuit:null, tags:['wildsuit','suit'],           desc:'Wild suit - becomes any suit to complete a flush. Has no rank.' },
...
//  { id:'shortcut',      name:'Shortcut',       emoji:'⏩', rarity:'legendary', activation:'on_play',    durability:1,          defaultRank:null, defaultSuit:null, tags:['challenge'],                 desc:'Play it in any 4-card hand to instantly complete the active challenge. (Once)' },
  ...
  { id:'dazed',         name:'Fresh Start',    emoji:'😵', rarity:'rare',     activation:'on_swap',    durability:'infinite', defaultRank:null, defaultSuit:null, tags:['grid'],                      desc:'When swapped, reshuffles every card on the grid.' },
  ...
  { id:'cash_out',       name:'Cash Out',       emoji:'💰', rarity:'rare',    activation:'on_discard', durability:4,          defaultRank:null, defaultSuit:null, tags:['resource','coins'],   desc:'Discard this: gain 10 credits. (4 charges)' },
  { id:'last_call',      name:'Last Call',      emoji:'⏳', rarity:'rare',      activation:'on_discard', durability:2,          defaultRank:null, defaultSuit:null, tags:['time'],               desc:'Discard this in the final minute of a round to rewind the clock 15 seconds. (2 charges)' },
  ...
  { id:'the_wanderer',   name:'Wanderer',       emoji:'🧭', rarity:'rare',    activation:'on_swap',    durability:'infinite', defaultRank:null, defaultSuit:null, tags:['resource'],           desc:'Swap with any card on the grid for free (+1 swap)' },
  // ── Double-tap-based ──
  ...
  { id:'capacitor', name:'Capacitor', emoji:'🔋', rarity:'common', activation:'double_tap', durability:1, defaultRank:null, defaultSuit:null, tags:['focus','coins'], desc:'Double-tap to spend 10 Focus and 10 seconds for 10 credits. Consumed on use.' },
  ...
  { id:'power_cell',  name:'Power Cell',  emoji:'🔋', rarity:'rare',   activation:'on_draw', durability:'infinite', defaultRank:null, defaultSuit:null, tags:['focus'], desc:'When it enters the grid: +10 Focus. While it remains on the grid: +10 maximum Focus.' },
