...
| Get Even | common | Hands with 3+ even-ranked cards score +2 mult per even card | +2 mult per even card | hands with 2+ even-ranked cards qualify for the bonus |  | O1 BAL · O2 code | you |
| Odd One In | rare | Hands with 3+ odd-ranked cards score +2 mult per odd card | +2 mult per odd card | 2+ odd-ranked cards qualify (-1 per improvement, min 1) |  | O1 BAL · O2 code | Claude |
...
| Study Hall | rare | Every 2 cards you score adds +1 Focus | +1 Focus per fire | fires every card scored instead of every 2 (-1 per improvement, min 1) |  | O1 BAL · O2 code | Claude |
...
| Cull | common | Discarding adds 1 Focus per swap and discard you have left | +1 Focus per unit of stock left | swapping pays it too |  | O1 code · O2 code | you |
...
| Pivot! | common | Cards touching Pivot swap for free. Swap two of its neighbours together and both gain +5 permanent mult, then Pivot leaves the board. (3 charges) | +5 permanent mult | +1 charge |  | O1 BAL · O2 charges | Claude |
